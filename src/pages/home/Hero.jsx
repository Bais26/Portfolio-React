    ...
    return (
        <section class="text-gray-200 body-font h-screen flex">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <h2 className='text-2xl mb-4'>Hello, <span className='text-[#0872BF]'>I'm</span></h2>
                    <h1 class="title-font text-6xl mb-4 font-bold text-[#0872BF]">M Bais Yufan Mardiansah
                    </h1>
                    <h2 className='text-2xl mb-4'>Frontend Developer</h2>
                    <p class="mb-8 leading-relaxed text-xl w-1/2">I am committed to finding innovative solutions and continuously experimenting to help my clients achieve their goals.</p>
                    <div class="flex justify-center mb-4">
                        <button class="inline-flex text-white bg-gradient-to-r from-[#0872BF] to-[#0D92AF] border-0 focus:outline-none rounded text-xl p-2">let's connect</button>
                    </div>
                    ...
                    <span class="sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start gap-4 flex items-center mx-4">
                        <div className="flex items-center rounded-full w-10 h-10 justify-center bg-[#0872BF]">
